...
export default {
  ...
  methods: {
    ...
    Accept(id){
      const _this= this
      _this.$axios.put("http://localhost:8081/admin/operate/goods?offShell="+true+"&recordId="+id).then(res => {
        console.log(res)
    ...
    Reject(id){
      const _this= this
      _this.$axios.put("http://localhost:8081/admin/operate/goods?offShell="+false+"&recordId="+id).then(res => {
        console.log(res)
        _this.$axios.get("/admin/complain/goods/not").then(res => {
          console.log(res)
